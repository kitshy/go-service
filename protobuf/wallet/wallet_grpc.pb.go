...
const (
	WalletService_GetSupportCoins_FullMethodName  = "/wallet.WalletService/getSupportCoins"
	WalletService_GetWalletAddress_FullMethodName = "/wallet.WalletService/getWalletAddress"
)
